...
<a data-toggle="modal" data-target="#exampleModal" className="btn text-muted bg-white mr-2"><i className="icofont-filter mr-1"></i> Filter</a>
<a data-toggle="modal" data-target="#exampleModal" className="btn text-muted bg-white"><i className="icofont-signal mr-1"></i> Sort</a>
</div>
</div>
<div className="row">
...
<input type='button' value='-' className='qtyminus btn btn-success btn-sm' />
<input type='text' name='quantity' value='1' className='qty form-control' />
<input type='button' value='+' className='qtyplus btn btn-success btn-sm' />
</form>
</span>
</div>
</div>
...
<div className="d-flex align-items-center">
<h6 className="price m-0 text-success">$0.8/kg</h6>
<a data-toggle="collapse" href="#collapseExample8" role="button" aria-expanded="false" aria-controls="collapseExample8" className="btn btn-success btn-sm ml-auto">+</a>
...
<div className="d-flex align-items-center">
<h6 className="price m-0 text-success">$2.5/kg</h6>
<a data-toggle="collapse" href="#collapseExample9" role="button" aria-expanded="false" aria-controls="collapseExample9" className="btn btn-success btn-sm ml-auto">+</a>
...
<div className="d-flex align-items-center">
<h6 className="price m-0 text-success">$0.8/kg</h6>
<a data-toggle="collapse" href="#collapseExample10" role="button" aria-expanded="false" aria-controls="collapseExample10" className="btn btn-success btn-sm ml-auto">+</a>
